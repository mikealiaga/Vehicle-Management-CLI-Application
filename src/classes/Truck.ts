...
class Truck extends Vehicle implements AbleToTow{
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    ...
    "make" in vehicle ? towedMake = vehicle.make : towedMake = "no make"; 
    "model" in vehicle ? towedModel = vehicle.model : towedModel = "no model"; 

    vehicle.weight < this.towingCapacity ? console.log(`Vehicle Make: ${towedMake} - Model ${towedModel} is being towed`) : console.log(`Vehicle Make: ${towedMake} - Model ${towedModel} too heavy`);
  }
