    ...
    inquirer
      ...
      .then((answers) => {
        ...
        const truck = new Truck(
          Cli.generateVin(), // Use Cli.generateVin() to generate the VIN
          answers.color,
          answers.make,
          answers.model,
          parseInt(answers.year),
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (selectedVehicle.vin === truck.vin) {
          ...
          this.performActions(); // Allow user to select another action
          return;
        }
      ...
      .catch((error) => {
        ...
        this.performActions(); // Return to actions menu in case of error
      });
  }
        ...
        for (let i = 0; i < this.vehicles.length; i++) {
          if (this.vehicles[i].vin === this.selectedVehicleVin) {
            ...
            (this.vehicles[i] as Motorbike).wheelie();
              ...
              console.log("vehicle not a Motorbike");
            }
          }
        }
      
      // TODO: add statements to perform the tow action only if the selected vehicle is a truck. Call the findVehicleToTow 
      // method to find a vehicle to tow and pass the selected truck as an argument. After calling the findVehicleToTow method, 
